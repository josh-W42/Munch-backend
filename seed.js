...
const categories = [
  // multiple categories
  {
    name: "breakfast",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615492619/fried-egg_a28qsd.png",
  },
  {
    name: "brunch",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615492669/cocktail_f9eb9c.png",
  },
  {
    name: "lunch",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615493643/cheeseburger_ugql4l.png",
  },
  {
    name: "dinner",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615493350/food-tray_azcja1.png",
  },
  {
    name: "ramen",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615492635/ramen_gqml0y.png",
  },
  {
    name: "japanese",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615492661/onigiri_cgfvga.png",
  },
  {
    name: "thai",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615493359/curry_cbxvke.png",
  },
  {
    name: "mexican",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615492648/taco_qfobgo.png",
  },
  {
    name: "vegetarian",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615493595/carrot_xwimty.png",
  },
  {
    name: "vegan",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615493194/salad_1_a8ekmc.png",
  },
  {
    name: "halal",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615493185/falafel_misghn.png",
  },
  {
    name: "mediterranean",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615493496/sandwich_kdw1yu.png",
  },
  {
    name: "italian",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615493545/pasta_u66jrx.png",
  },
  {
    name: "chinese",
    picture:
      "https://res.cloudinary.com/dom5vocai/image/upload/v1615537862/chinese-food_hr4i8q.png",
  },
];
...
const oneRestaurant = {
  ...
  password: "password",
  profileUrl:
    "https://res.cloudinary.com/dom5vocai/image/upload/v1614931585/oi0yvlmmt9xtoxzzpj5t.jpg",
  menu: [
    {
      name: "Tonkotsu Ramen",
...
const joshBobBurger = {
  ...
  password: "password",
  profileUrl:
    "https://assets.bonappetit.com/photos/5a33fb9b7d4b9b484283f0cd/master/pass/bobs-burgers-restaurant.jpg",
  menu: [
    {
      name: "Josh's Burger",
...
const nelsonTipico = {
  ...
  password: "password",
  profileUrl:
    "https://images.unsplash.com/photo-1613478549952-47b2db19e194?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2550&q=80",
  menu: [
    {
      name: "Nelson's Plate",
      description:
        "A full on festive experience, featuring asada, mexican rice, beans, served with a side of fresh tortillas. ",
      price: 12,
      type: "Main",
    },
    {
    ...
    },
    {
      name: "Guacamole",
      description:
        "What did the tortilla chip say to the avocado? Well, this is guacward...",
      price: 2,
      type: "Sides",
    },
  ],
...
const andrewCityWok = {
  ...
  password: "password",
  profileUrl:
    "https://southparkstudios.mtvnimages.com/shared/locations/city-wok.jpg",
  menu: [
    {
    ...
    },
    {
      name: "Combo C",
      description:
        "No combo B. You order combo C and it comes with fortune cookie.",
      price: 12,
      type: "Combo",
    },
  ],
...
const jamesSurfandTurn = {
  ...
  password: "password",
  profileUrl:
    "https://images.unsplash.com/photo-1610989569147-a7699a437bac?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1649&q=80",
  menu: [
    {
...
const romeItalian = {
  ...
  password: "password",
  profileUrl:
    "https://images.unsplash.com/photo-1553342385-111fd6bc6ab3?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80",
  menu: [
    {
    ...
    },
    {
      ...
      description:
        "Pizza so good, you will remember the playground where you spent most of your days...",
      price: 15,
      type: "Pizza",
    },
  ],
...
const briansCrabShack = {
  ...
  password: "password",
  profileUrl:
    "https://images.unsplash.com/photo-1559814048-149b70765d47?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80",
  menu: [
    {
...
const nicksIceCream = {
  ...
  password: "password",
  profileUrl:
    "https://images.unsplash.com/photo-1501443762994-82bd5dace89a?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80",
  menu: [
    {
